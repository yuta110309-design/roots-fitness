(function () {
  ...
  if (trainerGroups) {
    ...
    function buildTrainerCardHtml(trainer) {
      ...
      var photoHtml = '<img class="trainer-card-photo-img" src="' + trainer.photo + '" alt="' + trainer.name + 'トレーナー" loading="lazy">';

      return (
        '<div class="trainer-card" role="button" tabindex="0" data-trainer-detail="' + trainer.id + '">' +
          '<div class="trainer-card-photo has-photo">' +
            photoHtml +
